...
mask_spr = spr_floriel;
idle_spr = spr_floriel;
walk_spr = spr_floriel_walk;
run_spr = spr_floriel_run;
ledge_spr = spr_floriel_ledge
jump_spr = spr_floriel_jump;
dash_air_spr = spr_floriel_round;
...
attack_spr[3] = spr_floriel_stab_right_arm
image_moving = 0;
condition_frame = 0
hurted = 0;
knockX = 0;
