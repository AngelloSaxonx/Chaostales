...
if mp_grid_path(obj_grid.grid,path,x,y-offsetY,targetX,targetY-offsetTargetY,true)
{
	...
	if place_meeting(x,y+1+yspd,obj_collision)
	{
		...
		else
		{
			...
			if (!collision_rectangle(bbox_left+(xspd*pit_rangeX),ground_y1,bbox_right+(xspd*pit_rangeX),ground_y1+1,obj_collision,false,true) && (ground_y1 >= obj_flower.bbox_bottom-1))
